  ...
  return (
    <section className='py-12 sm:py-20'>
        <div className='max-w-[1128px] h-full mx-auto px-4 sm:px-6'>
            <h2 className='text-gray-100 text-3xl font-extrabold text-center mb-4 sm:text-4xl'>Engajamento & conversão 🔥</h2>
            <p className='text-gray-500 text-xl text-center max-w-[620px] mx-auto'>Quando engajados, os colaboradores, além de cumprirem suas funções com excelência, se sentem mais valorizados e conectados aos objetivos corporativos.</p>
