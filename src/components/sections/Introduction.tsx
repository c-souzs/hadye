        ...
        <section className='pt-20'>
            <div className='max-w-[960px] w-full px-6 mx-auto'>
                <div>
                    ...
                    <p className='max-w-[630px] mx-auto text-xl text-gray-400 dark:text-gray-500 text-center mb-8'>Atráves de estudos, aplicamos estratégias de vendas e tráfego pago para atrair mais pessoas, aumentando conversão de vendas.</p>
                ...
                <img src={placeholderVideo} alt="Company video" className='mt-12 rounded block max-w-full cursor-pointer'/>
            </div>
        </section>
    ) 
}
